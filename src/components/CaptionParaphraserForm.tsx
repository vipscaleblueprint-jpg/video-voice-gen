...
export interface CaptionParaphraserPayload {
    caption: string;
    cta: string;
    language: string;
    platforms: string[];
...
interface CaptionParaphraserFormProps {
    onSubmit: (payload: CaptionParaphraserPayload) => Promise<void>;
    isLoading: boolean;
}

export const CaptionParaphraserForm = ({ onSubmit, isLoading }: CaptionParaphraserFormProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload: CaptionParaphraserPayload = {
