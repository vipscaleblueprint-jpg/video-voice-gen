            ...
            <div className="relative z-10 container max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="glass rounded-2xl p-6 md:p-8 shadow-card h-fit">
                        <AdsCopyForm onSubmit={handleSubmit} isLoading={isLoading} ctaLink={ctaLink} onCtaLinkChange={setCtaLink} />
                    </div>
                    ...
                    <div className="h-fit">
                        {isLoading ? <div className="glass rounded-2xl p-6 md:p-8 shadow-card flex flex-col items-center justify-center min-h-[300px] text-center">
                            ...
                            </div> : response ? <AdsResponseDisplay response={response} ctaLink={ctaLink} /> : <div className="glass rounded-2xl p-6 md:p-8 shadow-card flex flex-col items-center justify-center min-h-[300px] text-center">
